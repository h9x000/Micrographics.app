...
function IconNode({ el, strokeWidth }: { el: IconElement; strokeWidth: number }) {
  ...
  if (el.icon === "glyph") return <text x={s / 2} y={s * 0.68} textAnchor="middle" fontSize={s * 0.68} fontWeight={900} fill={el.fill} fontFamily={`"Geist Mono", "Geist", ${fontRoleFamilies.mono}`}>{el.label ?? "⌖"}</text>;
